...
private:
	...
	string lop;	//Right side of operation
	string op;   // the operation only one
	string rop; // the right side of operation
...
public:
	operatorassign(Point Lcorner, string LeftHS="", string lp="",string op="",string rp="");
	...
	void setlop(string R);
	void setop(string R);
	void setrop(string R);
