...
class writestat :
	public Statement
{
	string writetext;   //the thing u need to write
Connector *pOutConn;	//write statement Stat. has one Connector to next statement
...
public:
	writestat(Point Lcorner, string r="");
	
	void setwritetext(const string &L);
